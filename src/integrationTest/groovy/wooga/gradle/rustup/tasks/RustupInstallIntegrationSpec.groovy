...
class RustupInstallIntegrationSpec extends RustupTaskIntegrationSpec<Rustup> {
    ...
    def "can set property"() {
        ...
        "rustupHome"       | providerSet | "/some/path/to"            | "File"
        "rustupHome"       | providerSet | "/some/path/to"            | "Provider<Directory>"
        "rustupHome"       | setter      | "/some/path/to"            | "File"
        "rustupHome"       | setter      | "/some/path/to"            | "Provider<Directory>"

        "cargoHome"        | providerSet | "/some/path/to"            | "File"
        "cargoHome"        | providerSet | "/some/path/to"            | "Provider<Directory>"
        "cargoHome"        | setter      | "/some/path/to"            | "File"
        "cargoHome"        | setter      | "/some/path/to"            | "Provider<Directory>"
    ...
    def installRustup(File rustupHome, File cargoHome) {
        def out = new ByteArrayOutputStream()
        def err = new ByteArrayOutputStream()
        String prefixName = PlatformUtils.isWindows() ? "init.exe" : "init.sh"
        File rustupInstallScript = File.createTempFile("rustup", prefixName)
